        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-20">
          <div>
            ...
            <div className="space-y-4 text-lg text-gray-600">
              <p>
                Badilisha Properties was born from a simple observation: the traditional way of buying and selling homes doesn't work for everyone anymore.
              </p>
              <p>
                In a world where flexibility matters, where economic realities shift quickly, and where life circumstances change unexpectedly, homeowners need better options.
              </p>
              <p>
                We created a client-centered alternative that removes the waiting, reduces financial strain, and brings transparency to property transitions. Property trading isn't just innovative it's practical, fair, and built for real people navigating real life.
              </p>
            </div>
          </div>
          ...
          <div className="space-y-6">
            <div className="bg-gradient-to-br from-emerald-500 to-teal-600 rounded-2xl p-8 text-white">
              ...
              <p className="text-emerald-50 text-lg">
                To simplify property transitions and empower homeowners to move forward with confidence, clarity, and control—without the stress of traditional real estate.
              </p>
            </div>
            ...
            <div className="bg-gradient-to-br from-gray-900 to-gray-800 rounded-2xl p-8 text-white">
              ...
              <p className="text-gray-300 text-lg">
                A future where property transitions are seamless, accessible, and human-centered. Where technology meets empathy, and innovation serves real needs.
              </p>
            </div>
          </div>
        </div>
